...
export const Dot1Liggo = "J'ai réparé une partie cruciale de l'application en démontrant que le flux de travail, tel que défini par la documentation, ne correspondait pas au fonctionnement réel de l'application"
export const Dot2Liggo = "J'ai amélioré l'expérience utilisateur en uniformisant l'interface graphique, en modernisant le style de l'application et en rendant son utilisation plus intuitive"
export const Dot3Liggo = "J'ai participé à la clarification des besoins du client en assistant le chef de projet dans la rédaction des spécifications, la planification des sprints et des échéanciers"
