    ...
    return (
        <div className='header section__padding' id='home'>
            <div className='header-content'>
                ...
                <p>Bonjour, je m'appelle Jean-Philippe Anctil. J'évolue dans le domaine de l'ingénierie informatique depuis 2021 et je suis là pour concrétiser vos projets.</p>
            </div>
